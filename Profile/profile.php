...
if (isset($_SESSION['user_id']) && isset($_SESSION['username'])) {
    ...
    if (isset($_GET['search'])) {
        ...
        $posts = getAll1($conn, $userid);
    }
    $categories = get3Categoies($conn);
    $users = get($conn, $userid);
    $userl = getAlll($conn);
    $count = totaltweet($conn, $userid);
?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <body class="bg-gray-800" style="background-color: #15202b;">
        <!-- component -->
                            ...
                            <div>
                                ...
                                <div class="p-4">
                                    <div class="relative flex w-full">
                                        ...
                                        <!-- <a href="useedit.php" class="btn flex justify-center  max-h-max whitespace-nowrap focus:outline-none  focus:ring  max-w-max border bg-transparent border-blue-500 text-blue-500 hover:border-blue-800  items-center hover:shadow-lg font-bold py-2 px-4 rounded-full mr-0 ml-auto">Edit Profile</a> -->
                                        <!-- The button to open modal -->
                                        <label for="my_modal_6" class="btn flex justify-center  max-h-max whitespace-nowrap focus:outline-none  focus:ring  max-w-max border bg-transparent border-blue-500 text-blue-500 hover:border-blue-800  items-center hover:shadow-lg font-bold py-2 px-4 rounded-full mr-0 ml-auto">Edit Profile</label>
                                                ...
                                                <div class="flex flex-col">
                                                    <form action="req/user_edit.php" method="post" enctype="multipart/form-data">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="avatar_url" value="<?= $users['avatar'] ?>" hidden>
                                                            <input type="text" class="form-control" name="cover_url" value="<?= $users['cover'] ?>" hidden>
                                                            <h1 class="text-center text-2xl">Edit Profile</h1>
                                                        </div>
                                                        <div class="space-y3">
                                                            <div>
                                                                <div class="flex justify-center md rounded-full  avatar">
                                                                    <img style=" ;" class="md w-full h-full mb-2 relative border-4 border-gray-900" src="../upload/cover/<?= $users['cover'] ?>" alt="">
                                                                </div>
                                                                <label for="avatar" class="block mb-2 text-sm font-medium">Upload Cover</label>
                                                            ...
                                                            <div class="flex justify-center">
                                                                <hr class="rounded-full w-72 h-[2px] my-4  bg-gray-200 border-0 dark:bg-gray-700">
                                                            </div>
                                                            <div>
                                                                <div class="flex justify-center md rounded-full  avatar">
                                                                    <img style="height:9rem; width:9rem;" class="md rounded-full relative border-4 border-gray-900" src="../upload/Avatar/<?= $users['avatar'] ?>" alt="">
                                                                </div>
                                                                <label for="avatar" class="block mb-2 text-sm font-medium">Upload Avatar</label>
                                                                <input type="file" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" name="avatar">
                                                            </div>
                                                            <div class="flex justify-center">
                                                                <hr class="rounded-full w-72 h-[2px] my-4  bg-gray-200 border-0 dark:bg-gray-700">
                                                            </div>
                                                            <label for=" fname" class="block ml-2  mb-2 text-sm font-medium">Name</label>
                                                            <input type="text" name="fname" id="fname" class="text-sm rounded-lg focus:ring-blue-900 focus:border-blue-900 block w-full p-2.5 mb-7" value="<?= $users['fname'] ?>">
                                                            <label for="bio" class="block ml-2 mb-2 text-sm font-medium">Bio</label>
                                    ...
                                    <div class=" space-y-1 justify-center w-full mt-3 ml-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm leading-5 font-medium text-gray-600">@<?= $userid ?></p>
                                        ...
                                        <span>
                                            Following <?= likeCount($conn, $user_id) ?>
                                        </span>
                                        <span>
